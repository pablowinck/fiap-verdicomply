...
public class AuthorizationIT {
    ...
    @BeforeEach
    void setup() {
        // Obter token do admin para os testes usando as senhas definidas em
        // data-integracao.sql
    ...
    void auditorNaoDeveAcessarEndpointAdmin() {
        ...
        // Verificar que o status é um erro de acesso negado (403 ou 500 são aceitáveis
        // neste caso)
        assertTrue(
                resposta.getStatusCode() == HttpStatus.FORBIDDEN
                        || resposta.getStatusCode() == HttpStatus.INTERNAL_SERVER_ERROR,
                "O status da resposta deve ser FORBIDDEN ou INTERNAL_SERVER_ERROR, mas foi "
